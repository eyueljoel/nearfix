...
<div style="margin-bottom:24px;">
    <a href="{{ route('portfolio.index') }}" style="color:#8895aa; text-decoration:none; font-size:14px;">
        ← Back to Portfolio
    </a>
</div>

<div class="form-card">
    <h2 style="font-size:22px; font-weight:700; color:#1a1a2e; margin-bottom:4px;">Add Portfolio Item</h2>
    <p style="color:#8895aa; font-size:14px; margin-bottom:28px;">Share a piece of work you're proud of</p>
    ...
    <form method="POST" action="{{ route('portfolio.store') }}" enctype="multipart/form-data">
        ...
        <div class="field">
            ...
            <input type="text" id="title" name="title" value="{{ old('title') }}"
                   placeholder="e.g. Full House Electrical Wiring" required>
            @error('title') <div class="field-error">⚠ {{ $message }}</div> @enderror
        </div>

        <div class="field">
            <label for="description">Description</label>
            <textarea id="description" name="description" placeholder="Describe what you did, the challenge, and the result...">{{ old('description') }}</textarea>
        ...
        <div class="field-row">
            <div class="field">
                ...
                <input type="number" id="price_from" name="price_from" value="{{ old('price_from') }}"
                       placeholder="e.g. 1500" min="0" step="0.01">
                @error('price_from') <div class="field-error">⚠ {{ $message }}</div> @enderror
            </div>
            <div class="field">
        ...
        <div class="field">
            <label>Project Image <span style="color:#8895aa; font-weight:400;">(optional, max 3MB)</span></label>
            <div class="image-upload-area" style="position:relative;" id="uploadArea">
                <input type="file" name="image" accept="image/*" onchange="previewImage(this)" id="imageInput">
                <div id="uploadPlaceholder">
                    <div style="font-size:40px; margin-bottom:8px;">📷</div>
                    <div style="font-weight:600; color:#555;">Click to upload or drag &amp; drop</div>
                    <div style="font-size:12px; color:#8895aa; margin-top:4px;">JPEG, PNG, WebP up to 3MB</div>
                </div>
                <img id="imagePreview" style="display:none; max-height:200px; border-radius:8px; margin:auto;" alt="Preview">
            </div>
